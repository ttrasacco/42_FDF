...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/12/12 21:45:36 by ttrasacc          #+#    #+#             */
/*   Updated: 2016/12/12 21:46:01 by ttrasacc         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../libftprintf.h"

int			ft_print_int_d(t_arg elem, intmax_t i, char *str)
{
	int		len;
...
int			ft_print_d(t_arg elem, va_list *ap)
{
	...
	return (ft_print_int_d(elem, i, str));
}
